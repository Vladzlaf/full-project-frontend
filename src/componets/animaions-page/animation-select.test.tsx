...
import {  MenuItem } from './animation-list';
...
describe('AnimationList', () => {
  it('отображает элементы меню корректно для десктопной версии', () => {
    ...
    render(
      <BrowserRouter>
        <AnimationSelect menuItems={menuItemsDeckstop} /> {/* Pass menuItemsDeckstop as a prop */}
      </BrowserRouter>
    );
  ...
  it('отображает элементы меню корректно для мобильной версии', () => {
    ...
    render(
      <BrowserRouter>
        <AnimationSelect menuItems={menuItemsMobile} /> {/* Pass menuItemsMobile as a prop */}
      </BrowserRouter>
    );
